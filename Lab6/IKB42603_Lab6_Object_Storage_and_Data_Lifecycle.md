...
![Environment Setup Evidence](./Evidence/Figure%201.jpeg)
*Figure 1: Initialization of LocalStack with `ENFORCE_IAM=1` and AWS STS identity verification. Screenshot added from the Evidence folder.*
...
![Task 1 - Bucket Creation and Initial Upload](./Evidence/Figure%202.jpeg)
*Figure 2: Bucket `miit-patient-records-8048` creation and initial object upload with classification tagging.*

![Task 1 - Object Inventory and Verification](./Evidence/Figure%203.jpeg)
...
![Task 2 - Public Bucket Policy and Anonymous Data Exfiltration](./Evidence/Figure%204.jpeg)
...
![Task 3 - Policy Deletion and BPA Configuration](./Evidence/Figure%205.jpeg)
*Figure 5: Policy deletion, Block Public Access configuration showing all four flags set to `true`.*

![Task 3 - BPA Testing and Least Privilege Creation](./Evidence/Figure%206.jpeg)
*Figure 6: Guardrail verification and creation of least-privilege resource policy.*

![Task 3 - Least Privilege Policy Verification](./Evidence/Figure%207.jpeg)
...
![Task 4 - IAM User and S3ReadAll Policy Verification](./Evidence/Figure%208.jpeg)
*Figure 8: Verification of `ENFORCE_IAM=1` environment and `DataAnalyst` IAM user policy.*

![Task 4 - Access Key Generation and Profile Setup](./Evidence/Figure%209.jpeg)
*Figure 9: Generation of analyst access keys and configuration of the `analyst` profile.*

![Task 4 - Deny Resource Policy Definition](./Evidence/Figure%2010.jpeg)
*Figure 10: Definition of `deny-confidential.json` bucket resource policy.*

![Task 4 - Resource Policy Attachment](./Evidence/Figure%2011.jpeg)
*Figure 11: Application and verification of the resource policy with explicit Deny.*

![Task 4 - Policy Evaluation Tests](./Evidence/Figure%2012.jpeg)
...
![Task 5 - KMS Key Creation and Encryption Config](./Evidence/Figure%2013.jpeg)
*Figure 13: Generation of KMS CMK `eaad2c50-056f-48ca-aad2-93828a60536b` and encryption JSON configuration.*

![Task 5 - Bucket Encryption Verification](./Evidence/Figure%2014.jpeg)
*Figure 14: Verification of active bucket encryption rules enforcing `aws:kms` and `BucketKeyEnabled: true`.*

![Task 5 - Transparent Encryption Verification via Head-Object](./Evidence/Figure%2015.jpeg)
...
![Task 6 - Presigned URL Generation and Expiration Testing](./Evidence/Figure%2016.jpeg)
*Figure 16: Generation and execution of time-bounded Presigned URL.*

![Task 6 - Secure Transport Policy Definition](./Evidence/Figure%2017.jpeg)
*Figure 17: Configuration of the TLS enforcement policy containing `aws:SecureTransport: "false"`.*

![Task 6 - Bucket Operations Under Policy](./Evidence/Figure%2018.jpeg)
*Figure 18: Bucket inspection and interaction under the transport policy.*

![Task 6 - Bucket Policy Deletion and Recovery](./Evidence/Figure%2019.jpeg)
...
![Task 7 - Versioning and Object Version Stack](./Evidence/Figure%2020.jpeg)
...
![Task 8 - Lifecycle Configuration and Cryptographic Erasure](./Evidence/Figure%2021.jpeg)
