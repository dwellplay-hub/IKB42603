...
<br> **Name:** MUHAMMAD DANISH ISYRAQ BIN AB GHANI
...
All screenshots used for this report are stored in the same Lab1 folder as this report.

| Evidence File | Purpose |
|---|---|
| `2.1.png` | `Admins` group creation output |
| `2.2.png` | Admin user creation output |
| `2.3.png` | Least-privilege admin commands and group policy attachment |
| `2.4.png` | Membership verification for the admin user |
| `3.1.png` | Read-only analyst user creation output |
| `3.3.png` | Attached read-only policy for the analyst user |
| `4.1.png` | Access key creation for the analyst user |
| `4.2.png` | Access key listing output |
| `4.3.png` | Access key deactivation / rotation output |
| `5.0.png` | Namespace-related setup screenshot |
| `5.1.png` | Namespace creation or verification screenshot |
| `6.1.png` | Service account creation output |
| `6.2.png` | Role creation output |
| `6.3.png` | RoleBinding creation output |
| `7.png` | RBAC authorization test results |
| `Deliverables & Assessment_3. Verification Command.png` | Verification output for the RoleBinding YAML |
...
![Least privilege admin commands](2.3.png)
...
![CloudAdmin user creation](2.2.png)
...
![Verify Admins membership](2.4.png)
...
![Analyst read-only policy](3.3.png)
...
![Access key deactivation command](4.3.png)
...
![Session B cluster setup](5.0.png)
...
![Role and RoleBinding creation](6.3.png)
...
![RoleBinding YAML verification](Deliverables & Assessment_3. Verification Command.png)
